...
export const SourcesView = ({ sources }) => {
  ...
  return (
    <div className="tm-fade-up mx-auto max-w-4xl space-y-6">
      <div>
        <h2 className="font-heading text-4xl font-black uppercase tracking-tight text-white sm:text-5xl">{t.sourcesTitle}</h2>
        <p className="mt-1 text-gray-500">{t.sourcesSub}</p>
      </div>
